...
public class Correction {
	...
	/*private static SimpleDirectedWeightedGraph<Integer, CustomWeightedEdge> graph;
	private static List<BitSet> cycles;
	private static Map<Integer, CustomWeightedEdge> integerToEdgeMap;*/
	...
	public static double correctEdgesIteration(SimpleDirectedWeightedGraph<Integer, CustomWeightedEdge> graph, 
		...
		for (BitSet cycle : cycles) {
			...
			double edgePerturbation = -1.0 * cycleSum / (double) cycleLength;
		...
		System.out.println();
		System.out.println("Edge perturbations:");
